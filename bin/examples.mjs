#!/usr/bin/env node
// The examples, one per line — every src/<slug>/ carrying a manifest.json.
//
...
// exactly what it ships, and a workspace that isn't an example (src/home/, an
// unfinished sketch) is left out rather than breaking the deploy.
