...
export default function Grass({
  ...
  const boundingSphere = useMemo(
    () => new THREE.Sphere(new THREE.Vector3(), (Math.sqrt(2) * width) / 2),
    [width]
  )
  ...
  return (
    <group {...props}>
      ...
      <mesh position={[0, 0, 0]} geometry={groundGeo}>
        <meshStandardMaterial color="#05130a" roughness={1} />
      </mesh>
    </group>
  )
}
